...
public class SharePointListExample extends SharePointBaseExample {
	...
	public void querySharePointFolder(ListsSoap ls) throws Exception {	
		...
		System.out.println("List soap is "+ls);
	...
	protected void initialize() throws Exception {
		...
		InputStream in = SharePointListExample.class.getResourceAsStream("/SharePointListExample.properties");
