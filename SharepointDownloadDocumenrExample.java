...
public class SharepointDownloadDocumenrExample extends SharePointBaseExample{
	...
	public static void main(String[] args) {
		...
		logger.debug("main...");		
		try {		
			SharepointDownloadDocumenrExample example = new SharepointDownloadDocumenrExample();
			example.initialize();
			CopySoap p = example.getCopySoap();
			example.DownLoadfiletolocal(p, properties.getProperty("download.location"));
		} catch (Exception ex) {
